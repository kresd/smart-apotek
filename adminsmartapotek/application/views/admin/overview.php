...
<html lang="en">
  ...
  <head>
    ...
    <title>ADMIN SMART APOTEK</title>
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="apotek.html">
            <i class="fas fa-fw fa-home"></i>
            <span>Kelola Data Apotek</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="apoteker.html">
            <i class="fas fa-fw fa-users"></i>
            <span>Kelola Data Apoteker</span></a>
        </li>
      <li class="nav-item">
